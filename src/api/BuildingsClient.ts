// --- START OF FILE BuildingsClient.ts ---
...
export class BuildingsClient implements interfaces.IBuildingsClient {
     ...
     * @return OK
     */
    buildings_GetAll(pageNumber: number | undefined, pageSize: number | undefined, sorting_Field: string, sorting_Direction: enums.SortDirection | undefined): Promise<types.BuildingListResponseDtoPagedResponseApiResponse> {
     ...
     * @return OK
     */
    buildings_GetByTmId(tmId: string, pageNumber: number | undefined, pageSize: number | undefined, sorting_Field: string, sorting_Direction: enums.SortDirection | undefined): Promise<types.BuildingListResponseDtoPagedResponseApiResponse> {
     ...
     * @return OK
     */
    buildings_Search(pageNumber: number | undefined, pageSize: number | undefined, sorting_Field: string, sorting_Direction: enums.SortDirection | undefined, body: types.BuildingSearchDto | undefined): Promise<types.BuildingListResponseDtoPagedResponseApiResponse> {
     ...
     * @return OK
     */
    buildings_GetByType(type: enums.BuildingType, pageNumber: number | undefined, pageSize: number | undefined, sorting_Field: string, sorting_Direction: enums.SortDirection | undefined): Promise<types.BuildingListResponseDtoPagedResponseApiResponse> {
     ...
     * @return OK
     */
    buildings_GetInMETUScope(pageNumber: number | undefined, pageSize: number | undefined, sorting_Field: string, sorting_Direction: enums.SortDirection | undefined): Promise<types.BuildingListResponseDtoPagedResponseApiResponse> {
...
// --- END OF FILE BuildingsClient.ts ---